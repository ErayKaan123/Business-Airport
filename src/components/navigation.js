...
export default function Navigation() {
    return (
        <div className="fixed flex w-full h-[100px] bg-[#040404] text-[#fffff2]" style={{ flexDirection: "row", alignItems: "center", zIndex: "100" }}>
            <nav className="max-w-[100rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
                <a className="flex-none text-xl font-semibold dark:text-white" href="#">
                    ...
                    <p style={{ fontSize: "70px", display: "inline", fontFamily: "Lobster, cursive", fontWeight: "400" }}>RPort</p>
                </a>
