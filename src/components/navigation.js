...
export default function Navigation() {
    return (
        <div className="fixed flex w-full h-[100px] bg-[#040404] text-[#fffff2]" style={{ flexDirection: "row", alignItems: "center", zIndex: "100",  boxShadow: "0 5px 25px #040404" }}>
            <nav className="max-w-[105rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
                <a className="flex-none text-xl mt-8 font-semibold dark:text-white" href="#">
                    <img style={{ height: "80%", display: "inline", marginRight: "10px" }} src="Images/RPortIcon.svg" alt="RPort Icon" />
